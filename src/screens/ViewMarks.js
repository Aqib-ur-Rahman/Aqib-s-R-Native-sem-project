...
const ViewMarks = ({ route }) => {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.marksBox}>
      ...
      <Text style={styles.marks}>First Term: {item.FirstTerm.obtained}</Text>
      <Text style={styles.marks}>Mid Term: {item.MidTerm.obtained}</Text>
      <Text style={styles.marks}>Final Term: {item.FinalTerm.obtained}</Text>
    </View>
  );
